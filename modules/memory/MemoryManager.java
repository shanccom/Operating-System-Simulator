...
public abstract class MemoryManager {
  protected static class Frame {
    ...
    public String toString() {
        return isOccupied ? String.format("[%s:P%d]", processId, pageNumber) : "[FREE]";
    }
  }
  ...
  protected void loadPageToFrame(int frameIndex, String pid, int pageNumber) {
    ...
    totalPageLoads++;
    Logger.debug("Pagina " + pageNumber + " del proceso " + pid + " cargada en marco " + frameIndex);
  }
  ...
  public synchronized boolean isPageLoaded(String pid, int pageNumber) {
      return processPageMap.containsKey(pid) && processPageMap.get(pid).contains(pageNumber);
  }
  ...
  public void printMetrics() {
    ...
    Logger.log("Tasa de fallos: " + String.format("%.2f%%", (double) pageFaults / totalPageLoads * 100));
    Logger.separator();
  }
